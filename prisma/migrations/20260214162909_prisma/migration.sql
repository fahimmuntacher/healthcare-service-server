/*
  ...
  - You are about to drop the column `appintementFee` on the `doctor` table. All the data in the column will be lost.
  - You are about to drop the column `needPasswordChange` on the `doctor` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "doctor" DROP COLUMN "appintementFee",
...
-- RenameIndex
ALTER INDEX "doctor_email_index" RENAME TO "idx_doctor_email";

-- RenameIndex
ALTER INDEX "doctor_isDeleted_index" RENAME TO "idx_doctor_isDeleted";
